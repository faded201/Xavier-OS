...
const XavierOS = () => {
  ...
  const playChunk = async (chunksArray, index, bookData) => {
    ...
    // Create image prompt that follows the story narrative
    const imagePrompt = `Cinematic scene: ${protagonist} in ${bookData.title}. ${safeText}. Detailed character portrait, story-accurate, dramatic lighting, book cover art style`;
